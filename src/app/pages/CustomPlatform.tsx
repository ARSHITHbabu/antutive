          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-10" style={{ animation: "fadeUp 0.8s ease 0.45s both" }}>
                <Link to="/contact" className="hero-btn-primary">Discuss Your Platform</Link>
                <Link to="#deployment" className="hero-btn-secondary">View Deployment Options</Link>
              </div>
      ...
      <section className="py-24 relative overflow-hidden"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-h2 mt-3" style={{ fontWeight: 700, color: "#0f172a" }}>Built on Three Principles</h2>
            <p className="text-sm mt-3 max-w-xl mx-auto" style={{ color: "#64748b" }}>Not a white-label chatbot. An enterprise-grade AI workspace built around how your specific organisation works.</p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-h2 mt-3" style={{ fontWeight: 700, color: "#0f172a" }}>What Your Platform Can Do</h2>
            <p className="text-sm mt-3 max-w-xl mx-auto" style={{ color: "#64748b" }}>Six core capabilities that transform how your organisation works with AI - all running on your own infrastructure.</p>
          </div>
      ...
      <section id="deployment" className="py-24 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-h2 mt-3" style={{ fontWeight: 700, color: "#0f172a" }}>Four Deployment Models</h2>
            <p className="text-sm mt-3 max-w-lg mx-auto" style={{ color: "#64748b" }}>Choose the model that matches your data residency requirements, technical capability, and risk tolerance.</p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-h2 mt-3" style={{ fontWeight: 700, color: "#0f172a" }}>Competitive Differentiation</h2>
            <p className="text-sm mt-3 max-w-xl mx-auto" style={{ color: "#64748b" }}>How ANTUTIVE's custom AI platform compares against the alternatives your team may already be considering.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {competitors.map((c, i) => (
      ...
      <section className="py-20 relative overflow-hidden"
        ...
        <Reveal variant="flip">
          <div className="max-w-2xl mx-auto px-4 text-center relative">
            <h2 className="section-h2 mb-4" style={{ fontWeight: 700, color: "#0f172a" }}>Design Your Platform</h2>
            <p className="text-sm mb-8 leading-relaxed" style={{ color: "#64748b" }}>Every deployment is purpose-built. Book a session to discuss your workflow, data residency requirements, and model preferences.</p>
