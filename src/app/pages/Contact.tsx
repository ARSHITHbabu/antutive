...
function ContactHeroCard() {
  ...
  return (
    <div className="p-6 rounded-3xl" style={{ background: "rgba(28,183,180,0.06)", border: "1px solid rgba(28,183,180,0.22)", backdropFilter: "blur(12px)", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
      ...
      <div className="mt-6 pt-5 border-t" style={{ borderColor: "rgba(28,183,180,0.18)" }}>
        <p className="text-xs text-[#64748b] leading-relaxed">Submit the form or email us directly. We respond within one business day — no sales pressure, just a fit conversation.</p>
      </div>
    </div>
  );
}
    ...
    <div>
      ...
      >
        ...
        <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full pointer-events-none"
          style={{ background: "radial-gradient(circle,rgba(28,183,180,0.09),transparent 70%)", filter: "blur(40px)" }} />
        <div className="absolute -bottom-20 -left-20 w-72 h-72 rounded-full pointer-events-none"
          style={{ background: "radial-gradient(circle,rgba(111,60,195,0.08),transparent 70%)", filter: "blur(30px)" }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-[#0f172a]">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#1CB7B4]/25 bg-[#1CB7B4]/06 backdrop-blur-sm mb-6"
                ...
                <span className="text-xs font-bold tracking-widest uppercase text-[#1CB7B4]">Contact ANTUTIVE AB</span>
              </div>
      ...
      <section className="py-24 relative overflow-hidden"
        ...
        <div className="absolute top-20 right-10 w-80 h-80 rounded-full pointer-events-none"
          style={{ background: `radial-gradient(circle,${A}0c,transparent 70%)`, filter: "blur(70px)" }} />
            ...
            {processSteps.map((s, i) => (
              <Reveal key={i} variant="scale" delay={i * 80}>
                <div className="p-6 rounded-2xl h-full transition-all duration-300 hover:-translate-y-1"
                  style={{ background: "#ffffff", border: `1px solid ${A}18`, backdropFilter: "blur(12px)", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1 flex flex-col gap-5">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 p-4 rounded-2xl border transition-all duration-300 hover:-translate-y-0.5"
                    style={{ background: "#ffffff", borderColor: `${A}18`, backdropFilter: "blur(8px)", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
                ...
                <div className="p-5 rounded-2xl border" style={{ background: "#ffffff", borderColor: `${A}18`, backdropFilter: "blur(8px)", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
                ...
                <div className="p-5 rounded-2xl border" style={{ background: "#ffffff", borderColor: `${A}14`, backdropFilter: "blur(8px)", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            ...
            <div className="lg:col-span-2">
              <Reveal variant="right" delay={100}>
                {submitted ? (
                  <div className="p-10 rounded-3xl border text-center" style={{ borderColor: `${A}18`, background: "#ffffff", backdropFilter: "blur(10px)", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
                  ...
                  <div className="p-8 rounded-3xl border" style={{ borderColor: `${A}18`, background: "#ffffff", backdropFilter: "blur(12px)", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
                        ...
                        {[
                          ...
                          <div key={id}>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border text-sm text-[#0f172a] placeholder:text-[#94a3b8] outline-none transition-all focus:border-[#1CB7B4]"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            required
                            className="w-full px-4 py-3 rounded-xl border text-sm text-[#0f172a] outline-none transition-all focus:border-[#1CB7B4]"
                            style={{ borderColor: `${A}22`, background: "#f8fafc" }}
                          >
